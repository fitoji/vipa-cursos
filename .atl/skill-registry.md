...
| `building-components`            | Reusable React component patterns and composition                                     | `/Volumes/SSD Samsung MAC/DEV SSD/NUEVA GENERACION/vipa-cursos/.agents/skills/building-components/SKILL.md`        |
...
| `postgres-best-practices`        | PostgreSQL patterns, queries, and optimization                                        | `/Volumes/SSD Samsung MAC/DEV SSD/NUEVA GENERACION/vipa-cursos/.agents/skills/postgres-best-practices/SKILL.md`  |
